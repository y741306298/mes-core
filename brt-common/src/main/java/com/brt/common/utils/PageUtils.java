...
import com.brt.common.core.page.PagePlus;
import com.brt.common.core.page.TableDataInfo;
import com.brt.common.enums.HttpMethodEnums;
import com.github.pagehelper.PageHelper;
import com.brt.common.core.page.PageDomain;
import com.brt.common.core.page.TableSupport;
import com.brt.common.utils.sql.SqlUtil;
...
public class PageUtils extends PageHelper
{
    ...
    public static <T> Page<T> buildPage(String defaultOrderByColumn, String defaultIsAsc) {
        ...
        //根据不同的请求类型获取分页参数
        if (ServletUtils.getMethod().equals(HttpMethodEnums.POST.getMethod())){
            pageNum = ServletUtils.getJsonParameterToInt(PAGE_NUM, DEFAULT_PAGE_NUM);
            pageSize = ServletUtils.getJsonParameterToInt(PAGE_SIZE, DEFAULT_PAGE_SIZE);
        }else {
            pageNum = ServletUtils.getParameterToInt(PAGE_NUM, DEFAULT_PAGE_NUM);
            pageSize = ServletUtils.getParameterToInt(PAGE_SIZE, DEFAULT_PAGE_SIZE);
        }
    ...
    public static <T> TableDataInfo<T> buildDataInfo(Page<T> page, Object data) {
        TableDataInfo<T> rspData = new TableDataInfo<>();
        rspData.setCode(HttpStatus.HTTP_OK);
        rspData.setMsg("查询成功");
        rspData.setRows(page.getRecords());
        rspData.setTotal(page.getTotal());
        rspData.setOtherData(data);
        return rspData;
    }
