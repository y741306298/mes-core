...
import com.brt.system.domain.SysUserOnline;
import com.brt.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController {
    ...
    /**
     * @description: TODO 获取在线的人数
     * @author: FanGN
     * @date: 22:43 2024/2/21
     * @param:
     * @return:
     * @return com.brt.common.core.domain.AjaxResult
     **/
    @GetMapping("/getOnLineUserNum")
    public AjaxResult getOnLineUserNum() {
        Collection<String> keys = redisCache.keys(CacheConstants.LOGIN_TOKEN_KEY + "*");
