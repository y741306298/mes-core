...
export default {
    name: "outInventoryPrint",
    props: ['orderId'],
    data() {
        return {
            // 打印设置
            printAre: {
                id: "outInventoryPrint",
            },
            // 表单参数
            form: {},
            // 表单校验
