  ...
  <div class="app-container">
    <el-row :gutter="20">
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" disabled>
          ...
          <el-row>
            <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="订单金额" prop="totalAmount" v-if="showPrice">
      ...
      <el-col :span="12">
        ...
        <el-divider></el-divider>
        <!-- 订单详情 -->
        <sales-order-details-list :isEdit="false" :orderId="orderId" :userId="form.userId" class="mb20"
  ...
  export default {
    ...
    methods: {
      ...
      getOrderInfo() {
        ...
        getSalesOrder(this.orderId).then(res => {
          this.form = res.data
