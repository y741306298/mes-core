<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="供应商名称" prop="supplierId" label-width="120">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['order:marketOrder:add']">新 增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="isEdit" @click="handleUpdate"
          v-hasPermi="['order:marketOrder:edit']">编 辑</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-dropdown split-button type="primary" @command="handleDropdownClick" size="mini">
          批量操作
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="copy" v-hasPermi="['order:marketOrder:copy']">复制订单</el-dropdown-item>
            <el-dropdown-item command="download">下载模板</el-dropdown-item>
            <el-dropdown-item command="export" v-hasPermi="['order:marketOrder:export']">导出销售单</el-dropdown-item>
            <el-dropdown-item command="print" :disabled="single"
              v-hasPermi="['order:marketOrder:print']">打印</el-dropdown-item>
            <el-dropdown-item command="delete" :disabled="multiple"
              v-hasPermi="['order:marketOrder:remove']">删除</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('order/marketOrder/importTemplate', {}, `template_${new Date().getTime()}.xlsx`)
    },
    /**
     * 批量操作按钮点击事件
     */
