    ...
    <el-row :gutter="20">
      ...
      <el-col :span="17">
        <el-card class="box-card">
          ...
          <!-- 订单详情 -->
          <price-sheet-order-details-list :isEdit="false" :orderId="orderForm.orderId" :userId="orderForm.userId" class="mb20"
            ref="priceSheetOrderDetailsRef"></price-sheet-order-details-list>
        </el-card>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    name: "PriceSheetOrderChildProcess",
    components: {
