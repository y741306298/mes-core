    ...
    <el-row :gutter="20">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="供应商名称" prop="supplierId">
                  <el-select v-model="orderForm.supplierId" @change="supplierChange" filterable
              ...
              <el-col :span="24">
                <el-form-item label="送货地址" prop="deliveryAddress">
                  ...
                  <!-- <el-select v-model="form.deliveryAddress" filterable class="drag-screenful-contnet">
                    <el-option v-for="(item,index) in supplierAddressList" :value="item.addressId"
                      :label="spliceSupplierAddress(item)"></el-option>
                  </el-select> -->
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <el-col :span="17">
        <el-card class="box-card">
          ...
          <!-- 订单详情 -->
          <market-order-details-list :isEdit="false" :orderId="orderForm.orderId" :userId="orderForm.userId" class="mb20"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /**
       * @param {Object} supplierId 监听供应商选择事件
       */
      supplierChange(supplierId) {
        if (!supplierId) {
          return;
        }
        const supplier = this.supplierList.find(o => o.supplierId == supplierId);
        this.form.contact = supplier.contact;
        this.form.contactTel = supplier.contactTel;

        let supplierAddressList = [{
          value: supplier.supplierAddress,
          address: supplier.supplierAddress,
        }, {
          value: supplier.logisticsAddress,
          address: supplier.logisticsAddress,
        }]
      ...
      querySearch(queryString, cb) {
        var restaurants = this.supplierAddressList;
      ...
      getSupplierList() {
        listSupplierAll({
          ...
          this.supplierChange(this.orderForm.supplierId);
        })
      },
      // 取消按钮
      cancel() {
